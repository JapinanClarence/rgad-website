...
export async function getIssues(): Promise<Issue[]> {
  ...
  return rows.map((item) => ({
    ...
    editorial: item.editorial ?? undefined,
    editorialAuthor: item.editorial_author ?? undefined,
...
export async function getIssueById(
  ...
  const issue: Issue = {
    ...
    editorial: archive.editorial ?? undefined,
    editorialAuthor: archive.editorial_author ?? undefined,
