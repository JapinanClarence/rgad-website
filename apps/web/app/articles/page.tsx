...
export const metadata: Metadata = {
  ...
  description: 'Browse our full library of gender and development research, policy briefs, and studies.',
}
...
const SAMPLE_ARTICLES = [
  {
    id: '1', slug: 'intersectionality-philippine-gender-policy',
    ...
    category: 'Gender Policy', author: 'Dr. Maria Santos', published_at: '2024-05-15',
  },
  {
    id: '2', slug: 'gad-budget-utilization-lgu',
    ...
    category: 'Governance', author: 'Atty. Rosa Dela Cruz', published_at: '2024-04-02',
  },
  {
    id: '3', slug: 'indigenous-women-ancestral-domain',
    ...
    category: 'Social Inclusion', author: 'Dr. Elena Matubang', published_at: '2024-03-18',
  },
  {
    id: '4', slug: 'magna-carta-women-implementation',
    title: 'Implementation Gaps in the Magna Carta of Women: A Decade Review',
    excerpt: 'Ten years after RA 9710s passage, this study assesses compliance levels across national agencies and identifies persistent implementation barriers.',
    category: 'Legal Framework', author: 'Atty. Rosa Dela Cruz', published_at: '2024-02-10',
  },
  {
    id: '5', slug: 'vawc-reporting-barriers-rural',
    title: 'Barriers to VAWC Reporting in Rural Philippine Communities',
    excerpt: 'Community-based research in three provinces reveals systemic, cultural, and logistical barriers that prevent survivors from accessing legal protection.',
    category: 'VAWC', author: 'Prof. Jose Reyes', published_at: '2024-01-25',
  },
  {
    id: '6', slug: 'gender-responsive-education-davao',
    title: 'Gender-Responsive Pedagogy in Davao Region Public Schools',
    excerpt: 'An action research project on the integration of GAD perspectives into classroom instruction, teacher training, and school policy.',
    category: 'Education', author: 'Dr. Ana Flores', published_at: '2023-12-05',
  },
]
...
export default async function ArticlesPage({
  ...
  try {
    let query = supabase
      .from('articles')
      .select('id, title, slug, excerpt, category, published_at, authors(name)')
      .eq('published', true)
    ...
    if (data && data.length > 0) {
      articles = data.map((a: any) => ({
        ...a,
        author: a.authors?.name ?? 'GAD Research Center',
      }))
    }
  } catch {}
    ...
    <div className="pt-20">
      ...
      <section className="py-16 hero-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-primary font-medium text-sm uppercase tracking-widest mb-3">Knowledge Base</p>
          <h1 className="font-display text-5xl lg:text-6xl font-bold mb-4">Research Articles</h1>
          <p className="text-xl text-muted-foreground max-w-2xl">
            Peer-reviewed studies, policy analyses, and field research on gender and development in the Philippines.
          </p>
        </div>
      </section>
            ...
            {articles.map((article) => (
              ...
              >
                <div className="h-3 w-full" style={{
                  background: 'linear-gradient(90deg, hsl(270,72%,40%), hsl(338,85%,50%))',
                  opacity: 0.7
                }} />
                <div className="p-6">
