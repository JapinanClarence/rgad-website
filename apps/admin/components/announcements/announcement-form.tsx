...
export function AnnouncementForm({
  ...
  const onSubmit: SubmitHandler<AnnouncementFormInput> = async (values) => {
    ...
    const result =
      mode === "edit" && announcementId
        ? await updateAnnouncementAction(announcementId, payload)
  ...
  const heading = mode === "edit" ? "Edit Announcement" : "New Announcement";
  const subheading =
    mode === "edit"
      ? "Update this announcement's details."
      : "Publish a new announcement for the network.";
  const saveLabel = mode === "edit" ? "Save Changes" : "Save Announcement";
